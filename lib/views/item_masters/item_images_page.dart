...
class ItemImagesPage extends StatelessWidget {
  ...
  final String itemName;
   ItemImagesPage({super.key,required this.itemCode,required this.itemName});

  final ItemMasterController imc = Get.put(ItemMasterController());
  @override
  Widget build(BuildContext context) {
    imc.getItemImages(itemCode: itemCode);
    return Container(
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        child: IconButton.filledTonal(
                                          ...
                                          onPressed: () {
                                            logic.confirmImageDeletion(itemCode: itemCode, imageCode: imageData.code);
                                          },
                                          splashRadius: 20,
                                          style: ButtonStyle(
